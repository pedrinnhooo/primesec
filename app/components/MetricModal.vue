...
<template>
  <UModal
    ...
    :ui="{
      ...
      content: 'bg-[#080b08] ring ring-white/10 divide-y divide-white/10 w-[calc(100%-1.5rem)] max-w-4xl max-h-[min(92vh,44rem)] overflow-hidden',
      ...
      <div class="flex min-w-0 flex-1 items-start gap-4 pr-10 sm:gap-5">
        ...
        <div class="min-w-0">
          <p class="font-mono text-[10px] uppercase tracking-[0.16em] text-primary/80">
            secfocus · {{ t('home.metrics.modal.theme') }} / {{ metric.id }}
          </p>
